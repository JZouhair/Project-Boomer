...
public class TraitementMetier {
	...
	// Add book
	public void AddBook(String libel, String desc, String autor, int quantite, boolean bloque){		
		interrepobook.save(new Book(libel, autor, desc, quantite,bloque));
	}
	...
	public void bloquerBook(Book book) {
		book.setBlouq(false);
		interrepobook.save(book);
	}
	
	public void debloquerBook(Book book) {
		book.setBlouq(true);
		interrepobook.save(book);
	}
